...
# scale (set size <gnuplot_x_scale>,<gnuplot_y_scale>).  The user can also
# specify how much dpi the final plot should be.
#
# Run this script as:
#
...
{
  # Get X and Y value and their base 10 logarithms.
  x = $1;
  y = $2;
